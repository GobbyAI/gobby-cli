...
- `CodewikiGraphEdge` (class) component `CodewikiGraphEdge [class]` (`7b2662e7-c5ec-53a2-b840-b18c7f5cd82b`) lines 71-93 [crates/gcode/src/commands/codewiki/types.rs:71-93]
  ...
  - Purpose: 'CodewikiGraphEdge' is a convenience constructor impl for creating directed graph edges between source and target component IDs, with fixed 'Call' or 'Import' edge kinds. [crates/gcode/src/commands/codewiki/types.rs:71-93]
- `CodewikiGraphEdge.call` (method) component `CodewikiGraphEdge.call [method]` (`7abffc1a-d8d6-5d9c-81e3-d4a386d22a1e`) lines 72-81 [crates/gcode/src/commands/codewiki/types.rs:72-81]
  ...
  - Purpose: Constructs and returns a 'CodewikiGraphEdge' of kind 'Call' by converting the provided source and target component IDs into owned strings and storing them in the new edge. [crates/gcode/src/commands/codewiki/types.rs:72-81]
- `CodewikiGraphEdge.import` (method) component `CodewikiGraphEdge.import [method]` (`5e433050-7f6e-5d16-be55-99acacb43556`) lines 83-92 [crates/gcode/src/commands/codewiki/types.rs:83-92]
  ...
  - Purpose: Constructs a 'CodewikiGraphEdge' representing an 'Import' edge by converting the source and target component IDs into owned strings and setting 'kind' to 'CodewikiGraphEdgeKind::Import'. [crates/gcode/src/commands/codewiki/types.rs:83-92]
...
- `CodewikiGraph` (class) component `CodewikiGraph [class]` (`0e5f4ca7-1e31-5ae4-b7c5-237e470fefa5`) lines 102-105 [crates/gcode/src/commands/codewiki/types.rs:102-105]
  ...
  - Purpose: 'CodewikiGraph' is a crate-visible struct that models a graph via a collection of 'CodewikiGraphEdge' values plus a 'CodewikiGraphAvailability' state. [crates/gcode/src/commands/codewiki/types.rs:102-105]
- `CodewikiGraph` (class) component `CodewikiGraph [class]` (`32c38a11-747d-5bdf-bfaf-884842979097`) lines 107-128 [crates/gcode/src/commands/codewiki/types.rs:107-128]
  ...
  - Purpose: 'CodewikiGraph' is a simple value type with three constructors that produce a graph from a 'Vec<CodewikiGraphEdge>' and set its 'availability' state to 'Available', 'Truncated', or 'Unavailable' (with no edges). [crates/gcode/src/commands/codewiki/types.rs:107-128]
- `CodewikiGraph.available` (method) component `CodewikiGraph.available [method]` (`15350b7d-e950-5162-ada0-df93298aa283`) lines 108-113 [crates/gcode/src/commands/codewiki/types.rs:108-113]
  ...
  - Purpose: Constructs a 'Self' instance from the provided 'edges' vector and sets 'availability' to 'CodewikiGraphAvailability::Available'. [crates/gcode/src/commands/codewiki/types.rs:108-113]
- `CodewikiGraph.truncated` (method) component `CodewikiGraph.truncated [method]` (`2d7b0f06-205b-5ea7-b4e2-dd7713944d6d`) lines 115-120 [crates/gcode/src/commands/codewiki/types.rs:115-120]
  ...
  - Purpose: Constructs a 'CodewikiGraph' instance from the provided 'edges' and sets its 'availability' to 'CodewikiGraphAvailability::Truncated'. [crates/gcode/src/commands/codewiki/types.rs:115-120]
- `CodewikiGraph.unavailable` (method) component `CodewikiGraph.unavailable [method]` (`38f1ee1d-3d9f-5f3a-89ad-6d31a73b8007`) lines 122-127 [crates/gcode/src/commands/codewiki/types.rs:122-127]
  ...
  - Purpose: Constructs and returns a 'Self' value with 'edges' initialized to an empty 'Vec' and 'availability' set to 'CodewikiGraphAvailability::Unavailable'. [crates/gcode/src/commands/codewiki/types.rs:122-127]
...
- `FileDoc` (class) component `FileDoc [class]` (`ccb940b9-5f60-5baa-803b-62aa7cb17627`) lines 138-150 [crates/gcode/src/commands/codewiki/types.rs:138-150]
  ...
  - Purpose: 'FileDoc' is a crate-visible record of a source file’s documentation metadata, capturing its path, module, summary, source spans, documented symbols, component IDs, and flags for degraded generation or verbatim page reuse. [crates/gcode/src/commands/codewiki/types.rs:138-150]
...
- `ModuleDoc` (class) component `ModuleDoc [class]` (`4bcaa055-ec29-57ec-bc24-be7dce48a12d`) lines 162-177 [crates/gcode/src/commands/codewiki/types.rs:162-177]
  ...
  - Purpose: 'ModuleDoc' is a crate-visible data structure that represents a module’s generated documentation, including its summary, provenance spans, linked files and child modules, component and graph metadata, and flags for generation failure or reused on-disk content. [crates/gcode/src/commands/codewiki/types.rs:162-177]
- `ArchitectureDoc` (class) component `ArchitectureDoc [class]` (`37d25365-97db-5f59-b3f4-85d69cb7b66c`) lines 180-186 [crates/gcode/src/commands/codewiki/types.rs:180-186]
  ...
  - Purpose: 'ArchitectureDoc' is an internal data container for an architecture document, holding source spans, a list of subsystems, optional narrative and dependency-diagram text, and a list of degraded source identifiers. [crates/gcode/src/commands/codewiki/types.rs:180-186]
...
- `OnboardingEntryPoint` (class) component `OnboardingEntryPoint [class]` (`17fbb5db-f369-5962-935c-dc929ff6071a`) lines 205-209 [crates/gcode/src/commands/codewiki/types.rs:205-209]
  ...
  - Purpose: 'OnboardingEntryPoint' is a crate-visible data container that identifies an onboarding destination by its 'link', human-readable 'description', and originating 'source_span' for source mapping. [crates/gcode/src/commands/codewiki/types.rs:205-209]
- `OnboardingStep` (class) component `OnboardingStep [class]` (`86c92c70-bb58-5f4b-8fbd-a0fb7b45c49e`) lines 212-217 [crates/gcode/src/commands/codewiki/types.rs:212-217]
  ...
  - Purpose: 'OnboardingStep' is a crate-private Rust struct that represents a single onboarding step with a module name, textual summary, and numeric ranking metadata ('degree' and 'score'). [crates/gcode/src/commands/codewiki/types.rs:212-217]
- `HotspotsDoc` (class) component `HotspotsDoc [class]` (`3541c462-4f7a-5228-b8d9-f105727b08b0`) lines 220-226 [crates/gcode/src/commands/codewiki/types.rs:220-226]
  ...
  - Purpose: 'HotspotsDoc' is a crate-private aggregate for hotspot analysis results, storing source spans, categorized hotspot findings ('hotspots', 'god_nodes', 'bridges'), and a list of degraded source identifiers. [crates/gcode/src/commands/codewiki/types.rs:220-226]
- `HotspotFinding` (class) component `HotspotFinding [class]` (`ed07f8f0-0b4e-5789-ba2b-2b2a942eb825`) lines 229-235 [crates/gcode/src/commands/codewiki/types.rs:229-235]
  ...
  - Purpose: 'HotspotFinding' is a package-private Rust struct that represents a hotspot analysis result for a 'HotspotNode', optionally carrying its degree, score, frequency, and weight metrics. [crates/gcode/src/commands/codewiki/types.rs:229-235]
- `HotspotNode` (class) component `HotspotNode [class]` (`633440f2-54ae-581a-be45-b0d660da08c2`) lines 238-245 [crates/gcode/src/commands/codewiki/types.rs:238-245]
  ...
  - Purpose: 'HotspotNode' is an internal Rust data structure that identifies a hotspot by 'id', 'kind', 'label', and 'wikilink', with optional 'file_wikilink' and 'SourceSpan' metadata for source-location context. [crates/gcode/src/commands/codewiki/types.rs:238-245]
- `FileLink` (class) component `FileLink [class]` (`a894167d-5cc7-5cce-812d-9b1d4a66cdfc`) lines 248-252 [crates/gcode/src/commands/codewiki/types.rs:248-252]
  ...
  - Purpose: 'FileLink' is an internal record that associates a file path with a textual summary and a collection of 'SourceSpan' references identifying the source locations that support or produced that summary. [crates/gcode/src/commands/codewiki/types.rs:248-252]
- `ModuleLink` (class) component `ModuleLink [class]` (`63896419-ca38-5388-8809-7ee9235e872d`) lines 255-259 [crates/gcode/src/commands/codewiki/types.rs:255-259]
  ...
  - Purpose: 'ModuleLink' is a crate-visible struct that stores a module identifier, a human-readable summary, and the associated source spans as a 'Vec<SourceSpan>'. [crates/gcode/src/commands/codewiki/types.rs:255-259]
- `SourceSpan` (class) component `SourceSpan [class]` (`8b708ae7-f26b-5ad2-bc7b-91c9ab89818a`) lines 262-266 [crates/gcode/src/commands/codewiki/types.rs:262-266]
  ...
  - Purpose: 'SourceSpan' is a crate-private struct that identifies a span of source code by filename and inclusive start/end line numbers. [crates/gcode/src/commands/codewiki/types.rs:262-266]
- `CodewikiRunSummary` (class) component `CodewikiRunSummary [class]` (`f56f0cea-c2df-533f-8dc5-03ff0c2a7c65`) lines 269-281 [crates/gcode/src/commands/codewiki/types.rs:269-281]
  ...
  - Purpose: 'CodewikiRunSummary' is a run-report struct that captures the executed command, project identity and paths, generated documentation output counts, changed file paths, skipped/file/module/symbol totals, and whether AI support was enabled. [crates/gcode/src/commands/codewiki/types.rs:269-281]
- `CodewikiMeta` (class) component `CodewikiMeta [class]` (`504f3a78-3d37-549f-a6aa-fcaf42792837`) lines 284-291 [crates/gcode/src/commands/codewiki/types.rs:284-291]
  ...
  - Purpose: 'CodewikiMeta' is a crate-visible metadata container holding a map of document metadata keyed by name, a list of generated document IDs, an optional index snapshot, and an AI mode string, with serde defaults/omission behavior on the optional and 'ai_mode' fields. [crates/gcode/src/commands/codewiki/types.rs:284-291]
- `CodewikiDocMeta` (class) component `CodewikiDocMeta [class]` (`f7061147-bbcb-53e2-92f5-ae21acd3606d`) lines 294-310 [crates/gcode/src/commands/codewiki/types.rs:294-310]
  ...
  - Purpose: 'CodewikiDocMeta' is a serialized metadata record for a generated codewiki document, tracking its input 'source_hashes', whether it was produced by a degraded fallback, an optional cached grounded 'summary' for reuse, and the 'ai_mode' used to generate it. [crates/gcode/src/commands/codewiki/types.rs:294-310]
- `BuiltDoc` (class) component `BuiltDoc [class]` (`d5d0d2ac-5f9b-54ab-abf3-6db45a8c4f3e`) lines 315-322 [crates/gcode/src/commands/codewiki/types.rs:315-322]
  ...
  - Purpose: 'BuiltDoc' is an internal document artifact that stores the document path, rendered content, a degradation flag, and an optional persisted grounded summary for reuse in later runs. [crates/gcode/src/commands/codewiki/types.rs:315-322]
- `BuiltDoc` (class) component `BuiltDoc [class]` (`030cd5dd-5bcc-53c5-9017-2dcb5401ad4a`) lines 324-333 [crates/gcode/src/commands/codewiki/types.rs:324-333]
  ...
  - Purpose: 'BuiltDoc' provides a 'healthy' constructor that creates a 'Self' instance from a path and content with 'degraded' set to 'false' and 'summary' set to 'None'. [crates/gcode/src/commands/codewiki/types.rs:324-333]
- `BuiltDoc.healthy` (method) component `BuiltDoc.healthy [method]` (`bd27cac4-5be6-5543-90cc-685e3c8d8d92`) lines 325-332 [crates/gcode/src/commands/codewiki/types.rs:325-332]
  ...
  - Purpose: Constructs and returns a new 'Self' instance with 'path' converted into a 'String', 'content' stored as provided, 'degraded' set to 'false', and 'summary' set to 'None'. [crates/gcode/src/commands/codewiki/types.rs:325-332]
- `CodewikiIndexSnapshot` (class) component `CodewikiIndexSnapshot [class]` (`793ba19c-7242-593a-907b-4ad6b323efcb`) lines 336-343 [crates/gcode/src/commands/codewiki/types.rs:336-343]
  ...
  - Purpose: 'CodewikiIndexSnapshot' is a serializable snapshot of a codewiki index containing ordered maps of file and symbol snapshots, plus optional graph neighborhood data and a list of degraded source identifiers. [crates/gcode/src/commands/codewiki/types.rs:336-343]
- `CodewikiFileSnapshot` (class) component `CodewikiFileSnapshot [class]` (`494dd863-11df-5506-9dad-48c6b877e7c1`) lines 346-349 [crates/gcode/src/commands/codewiki/types.rs:346-349]
  ...
  - Purpose: 'CodewikiFileSnapshot' is a crate-visible struct that records a file’s 'content_hash' and 'symbol_count' for snapshotting codewiki file state. [crates/gcode/src/commands/codewiki/types.rs:346-349]
- `CodewikiSymbolSnapshot` (class) component `CodewikiSymbolSnapshot [class]` (`18fc5913-7e9e-57a4-bcba-4d2398ff5eff`) lines 352-358 [crates/gcode/src/commands/codewiki/types.rs:352-358]
  ...
  - Purpose: 'CodewikiSymbolSnapshot' is a crate-private data record that captures a symbol’s source file path, simple and qualified names, kind, and starting line number. [crates/gcode/src/commands/codewiki/types.rs:352-358]
...
- `AiDepth` (class) component `AiDepth [class]` (`6b40e790-5306-593a-a9a9-e71dcd29ee28`) lines 386-402 [crates/gcode/src/commands/codewiki/types.rs:386-402]
  ...
  - Purpose: 'AiDepth' is an enum-like depth selector that exposes predicates for whether file or symbol information is included via ordinal comparison and maps each variant to a static mode label string. [crates/gcode/src/commands/codewiki/types.rs:386-402]
- `AiDepth.includes_files` (method) component `AiDepth.includes_files [method]` (`251ce9e7-d898-5de7-8dfa-028259086f2a`) lines 387-389 [crates/gcode/src/commands/codewiki/types.rs:387-389]
  ...
  - Purpose: Returns 'true' when 'self' is at least 'AiDepth::Files' in the enum ordering, and 'false' otherwise. [crates/gcode/src/commands/codewiki/types.rs:387-389]
- `AiDepth.includes_symbols` (method) component `AiDepth.includes_symbols [method]` (`8431e4de-af95-5aca-90c1-f84c941ec1de`) lines 391-393 [crates/gcode/src/commands/codewiki/types.rs:391-393]
  ...
  - Purpose: Returns 'true' when 'self' is at least 'AiDepth::Symbols', indicating that symbol-level depth is included. [crates/gcode/src/commands/codewiki/types.rs:391-393]
- `AiDepth.mode_label` (method) component `AiDepth.mode_label [method]` (`bb847fd1-570b-54b4-b37f-8068f7a1ba43`) lines 395-401 [crates/gcode/src/commands/codewiki/types.rs:395-401]
  ...
  - Purpose: Returns a static string label for the 'AiDepth' variant, mapping 'Sections' to '"sections"', 'Files' to '"files"', and 'Symbols' to '"symbols"'. [crates/gcode/src/commands/codewiki/types.rs:395-401]
- `CodewikiAiOptions` (class) component `CodewikiAiOptions [class]` (`3a3d4aa7-70ec-5909-ab11-086db68ceee7`) lines 405-411 [crates/gcode/src/commands/codewiki/types.rs:405-411]
  ...
  - Purpose: 'CodewikiAiOptions' is a configuration struct for codewiki AI behavior that optionally specifies routing and an aggregate documentation profile, and requires an 'AiDepth', defaulting 'aggregate_profile' to 'super::DEFAULT_AGGREGATE_PROFILE' when unset. [crates/gcode/src/commands/codewiki/types.rs:405-411]
- `SourceSpan` (class) component `SourceSpan [class]` (`09f67506-3dbc-52a9-b829-52768fe243e2`) lines 413-433 [crates/gcode/src/commands/codewiki/types.rs:413-433]
  ...
  - Purpose: 'SourceSpan' is a lightweight file-and-line-range value object that can be constructed from a 'Symbol', formatted as a citation string, and tested for whether it fully contains another source range. [crates/gcode/src/commands/codewiki/types.rs:413-433]
- `SourceSpan.from_symbol` (method) component `SourceSpan.from_symbol [method]` (`6f8366d7-bda3-5793-be52-e399e2ea7d5e`) lines 414-420 [crates/gcode/src/commands/codewiki/types.rs:414-420]
  ...
  - Purpose: Constructs a new instance by cloning the symbol’s 'file_path' into 'file' and copying its 'line_start' and 'line_end' fields directly. [crates/gcode/src/commands/codewiki/types.rs:414-420]
- `SourceSpan.citation` (method) component `SourceSpan.citation [method]` (`9970adb8-373b-5a21-92dd-a78d5ae4ee58`) lines 422-428 [crates/gcode/src/commands/codewiki/types.rs:422-428]
  ...
  - Purpose: Returns a formatted citation string for 'self.file' using a single line reference as '[file:line]' when 'line_start == line_end', otherwise a line range as '[file:start-end]'. [crates/gcode/src/commands/codewiki/types.rs:422-428]
- `SourceSpan.contains` (method) component `SourceSpan.contains [method]` (`95d68642-1786-5da5-ad81-ff8ae5ed68da`) lines 430-432 [crates/gcode/src/commands/codewiki/types.rs:430-432]
  ...
  - Purpose: Returns 'true' when the given 'file' matches 'self.file' and the requested line range '[line_start, line_end]' is fully contained within 'self.line_start..=self.line_end'. [crates/gcode/src/commands/codewiki/types.rs:430-432]
