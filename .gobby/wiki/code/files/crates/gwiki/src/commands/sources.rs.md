...
- `SourceListEntry` (class) component `SourceListEntry [class]` (`8918d9e3-b725-5e08-9d4b-c1333a590fa0`) lines 125-138 [crates/gwiki/src/commands/sources.rs:125-138]
  ...
  - Purpose: 'SourceListEntry' is a serialized record describing a source artifact, including its identity, kind, optional title and citation, fetch metadata, compilation status, raw file presence/path, content hash, location, and an optional associated source asset. [crates/gwiki/src/commands/sources.rs:125-138]
- `IndexStatus` (class) component `IndexStatus [class]` (`e773f602-c402-50a2-bd91-57b14bfa10f7`) lines 141-146 [crates/gwiki/src/commands/sources.rs:141-146]
  ...
  - Purpose: 'IndexStatus' is a serializable status payload that reports a static status string, a boolean indicating whether indexing is required, and an optional 'IndexedCounts' summary that is omitted from serialization when absent. [crates/gwiki/src/commands/sources.rs:141-146]
- `IndexStatus` (class) component `IndexStatus [class]` (`58a59908-ef07-5d1e-83f9-e6b7dc55d4eb`) lines 148-172 [crates/gwiki/src/commands/sources.rs:148-172]
  ...
  - Purpose: 'IndexStatus' is a small status-construction helper that creates immutable state values for indexing outcomes, representing 'not_run', 'indexed' with optional converted 'IndexedCounts', or 'degraded' with 'index_required' set to 'true'. [crates/gwiki/src/commands/sources.rs:148-172]
- `IndexStatus.not_run` (method) component `IndexStatus.not_run [method]` (`de0e5e0f-5317-54d4-abcc-fb01f5f10e7a`) lines 149-155 [crates/gwiki/src/commands/sources.rs:149-155]
  ...
  - Purpose: Constructs and returns a new 'Self' instance initialized with 'status' set to '"not_run"', 'index_required' set to 'false', and 'indexed' set to 'None'. [crates/gwiki/src/commands/sources.rs:149-155]
- `IndexStatus.indexed` (method) component `IndexStatus.indexed [method]` (`47b8b301-51d1-537a-bd5f-348f8b39d20f`) lines 157-163 [crates/gwiki/src/commands/sources.rs:157-163]
  ...
  - Purpose: Constructs a 'Self' value with 'status' set to '"indexed"', 'index_required' set to 'false', and 'indexed' initialized to 'Some(IndexedCounts::from(counts))'. [crates/gwiki/src/commands/sources.rs:157-163]
- `IndexStatus.degraded` (method) component `IndexStatus.degraded [method]` (`9905546e-9da0-55c4-9ec8-ed7c751d33d8`) lines 165-171 [crates/gwiki/src/commands/sources.rs:165-171]
  ...
  - Purpose: Returns a 'Self' instance representing a degraded state by setting 'status' to '"degraded"', 'index_required' to 'true', and 'indexed' to 'None'. [crates/gwiki/src/commands/sources.rs:165-171]
- `IndexedCounts` (class) component `IndexedCounts [class]` (`fe9bb971-5ef2-5469-9da9-999c18e4c0e1`) lines 175-181 [crates/gwiki/src/commands/sources.rs:175-181]
  ...
  - Purpose: 'IndexedCounts' is a value struct that tracks indexed entity totals across five categories: 'documents', 'chunks', 'links', 'sources', and 'ingestions'. [crates/gwiki/src/commands/sources.rs:175-181]
- `IndexedCounts` (class) component `IndexedCounts [class]` (`1f6e5e6c-0978-5e0d-8ec6-428a3d4daaf1`) lines 183-193 [crates/gwiki/src/commands/sources.rs:183-193]
  ...
  - Purpose: 'IndexedCounts' is a conversion target that implements 'From<IndexCounts>' by copying the 'documents', 'chunks', 'links', 'sources', and 'ingestions' fields from an 'IndexCounts' value into a new 'IndexedCounts' instance. [crates/gwiki/src/commands/sources.rs:183-193]
- `IndexedCounts.from` (method) component `IndexedCounts.from [method]` (`c7befe9b-6b20-57d1-b231-1151a10dbd92`) lines 184-192 [crates/gwiki/src/commands/sources.rs:184-192]
  ...
  - Purpose: Constructs 'Self' by transferring the 'documents', 'chunks', 'links', 'sources', and 'ingestions' fields from the given 'IndexCounts' value. [crates/gwiki/src/commands/sources.rs:184-192]
- `RemoveSourceRender` (class) component `RemoveSourceRender [class]` (`140d9da0-befb-53a7-9080-3799cc8e022d`) lines 195-205 [crates/gwiki/src/commands/sources.rs:195-205]
  ...
  - Purpose: 'RemoveSourceRender' is a data-only render model for presenting the outcome of a source-removal operation, including scope, dry-run state, the affected source entry, path classification, index status, degradations, and follow-up actions. [crates/gwiki/src/commands/sources.rs:195-205]
...
- `stage_source_asset` (function) component `stage_source_asset [function]` (`04a320e4-7c1f-538b-b5f1-cecdbc496e5c`) lines 318-340 [crates/gwiki/src/commands/sources.rs:318-340]
  ...
  - Purpose: Stages a source asset by either recording it as kept when 'keep_asset' is true, staging its removal if the resolved file exists under 'vault_root', or otherwise marking it missing and appending a 'source_asset_missing' degradation. [crates/gwiki/src/commands/sources.rs:318-340]
- `stage_source_removal` (function) component `stage_source_removal [function]` (`9c58c938-e5bf-52bb-89c3-12635742da40`) lines 342-363 [crates/gwiki/src/commands/sources.rs:342-363]
  ...
  - Purpose: 'stage_source_removal' records a source path as removed in 'PathChanges' and, when 'cache_bytes' is true, reads the file from 'vault_root' to store its bytes in 'staged_removals', returning a 'WikiError::Io' if the read fails. [crates/gwiki/src/commands/sources.rs:342-363]
- `remove_staged_source_files` (function) component `remove_staged_source_files [function]` (`4206c29c-562d-5f1f-955b-2b128ca7a17c`) lines 365-396 [crates/gwiki/src/commands/sources.rs:365-396]
  ...
  - Purpose: Removes each path in 'path_changes.staged_removals' from 'vault_root', recording successfully deleted relative paths in 'removed_paths', moving deleted entries into 'staged_removals', adding missing files to 'missing_paths', and rolling back partial progress while returning a 'WikiError::Io' on any other filesystem error. [crates/gwiki/src/commands/sources.rs:365-396]
- `restore_removed_source_files` (function) component `restore_removed_source_files [function]` (`3aaf390e-414f-5ab9-b57e-f6d902aa136b`) lines 398-441 [crates/gwiki/src/commands/sources.rs:398-441]
  ...
  - Purpose: Attempts to restore any staged source files that were actually removed by recreating their parent directories and rewriting their original bytes under 'vault_root', and if any restore step fails it returns a 'WikiError::Config' that includes the original error plus all restore failures. [crates/gwiki/src/commands/sources.rs:398-441]
- `rollback_removed_source_state` (function) component `rollback_removed_source_state [function]` (`e0c548de-92c2-51df-b9e7-8afaecf308be`) lines 443-462 [crates/gwiki/src/commands/sources.rs:443-462]
  ...
  - Purpose: Attempts to roll back a failed source removal by restoring the manifest entry and removed files, returning 'Ok(())' only if both succeed, otherwise propagating the single failure or synthesizing a 'WikiError::Config' when both rollback steps fail. [crates/gwiki/src/commands/sources.rs:443-462]
- `rollback_removed_source` (function) component `rollback_removed_source [function]` (`a4856219-1bda-59b4-9ea5-3232c19f0316`) lines 464-486 [crates/gwiki/src/commands/sources.rs:464-486]
  ...
  - Purpose: Attempts to restore a removed source by atomically appending the given 'SourceRecord' back into the source manifest unless that ID is already present, and converts any manifest-update failure into a 'WikiError::Config' that includes both the rollback error and the original removal error. [crates/gwiki/src/commands/sources.rs:464-486]
- `raw_source_path` (function) component `raw_source_path [function]` (`1d3a56df-c8f1-535d-82ad-63bcc3577694`) lines 488-490 [crates/gwiki/src/commands/sources.rs:488-490]
  ...
  - Purpose: Returns the result of 'paths::raw_source_path(id)', producing the raw source file path for the given 'id' or a 'WikiError' if path resolution fails. [crates/gwiki/src/commands/sources.rs:488-490]
- `source_asset_path` (function) component `source_asset_path [function]` (`a32c7141-942d-5e71-a0a3-5af5b52b1029`) lines 492-525 [crates/gwiki/src/commands/sources.rs:492-525]
  ...
  - Purpose: 'source_asset_path' validates and normalizes a vault-relative source asset path, requiring it to live under 'raw/assets' and, if the target exists, resolving both paths to ensure the canonicalized asset stays within the vault before returning the relative 'PathBuf'. [crates/gwiki/src/commands/sources.rs:492-525]
- `safe_vault_relative_path` (function) component `safe_vault_relative_path [function]` (`1a6f2012-20ca-5dda-8b31-d51fc0183004`) lines 527-566 [crates/gwiki/src/commands/sources.rs:527-566]
  ...
  - Purpose: Trims the input and returns a normalized vault-relative 'PathBuf' only if it is non-empty, contains no backslashes, is not absolute, and has no '..'/root/prefix components that would escape the vault, otherwise returning 'WikiError::InvalidInput'. [crates/gwiki/src/commands/sources.rs:527-566]
- `is_raw_asset_path` (function) component `is_raw_asset_path [function]` (`82ebddb6-0324-50c8-85ed-bf1deade3b97`) lines 568-573 [crates/gwiki/src/commands/sources.rs:568-573]
  ...
  - Purpose: Returns 'true' only when the path has at least three components and begins with the exact normal components 'raw' then 'assets', followed by at least one additional component. [crates/gwiki/src/commands/sources.rs:568-573]
- `ensure_scope_root` (function) component `ensure_scope_root [function]` (`a42e2107-589b-5133-b665-b82c632db8fa`) lines 575-585 [crates/gwiki/src/commands/sources.rs:575-585]
  ...
  - Purpose: Returns 'Ok(())' when 'root' exists and is a directory, otherwise returns 'WikiError::InvalidScope' with a message indicating the wiki scope root is missing or not a directory. [crates/gwiki/src/commands/sources.rs:575-585]
- `follow_up_for_removed_source` (function) component `follow_up_for_removed_source [function]` (`92c0eca5-908b-5c59-b059-8c9d792a8114`) lines 587-593 [crates/gwiki/src/commands/sources.rs:587-593]
  ...
  - Purpose: Returns '["audit_recommended"]' when the 'SourceRecord' is marked 'Compiled', otherwise returns an empty vector. [crates/gwiki/src/commands/sources.rs:587-593]
- `render_sources` (function) component `render_sources [function]` (`370097f7-06a9-54c4-9a4a-f058bcb72c5b`) lines 595-616 [crates/gwiki/src/commands/sources.rs:595-616]
  ...
  - Purpose: Builds a 'CommandOutcome' for the '"sources"' command by packaging the given 'scope', 'sources', and 'degradations' into a JSON payload, deriving a short summary text with source and degradation counts, and delegating to 'super::scoped_outcome'. [crates/gwiki/src/commands/sources.rs:595-616]
- `render_remove_source` (function) component `render_remove_source [function]` (`ce352531-6184-5c31-9171-c6f2547d20db`) lines 618-657 [crates/gwiki/src/commands/sources.rs:618-657]
  ...
  - Purpose: Builds a 'CommandOutcome' for a 'remove-source' operation by deriving a dry-run-aware status, assembling a JSON payload with scope, source, path, index, degradation, and follow-up details, formatting a human-readable summary, and delegating to 'scoped_outcome'. [crates/gwiki/src/commands/sources.rs:618-657]
- `display_path` (function) component `display_path [function]` (`5f8b3c2f-05cc-54c1-942f-7ec0b0943520`) lines 659-661 [crates/gwiki/src/commands/sources.rs:659-661]
  ...
  - Purpose: Converts a 'Path' to a lossy UTF-8 string and normalizes path separators by replacing backslashes with forward slashes. [crates/gwiki/src/commands/sources.rs:659-661]
- `source_listing_reads_manifest_raw_path_and_asset` (function) component `source_listing_reads_manifest_raw_path_and_asset [function]` (`21312e15-3e43-5528-a961-c32706c92ecd`) lines 669-695 [crates/gwiki/src/commands/sources.rs:669-695]
  ...
  - Purpose: Verifies that 'source_entries' returns a single entry for a seeded manifest record with no degradations, preserves the record ID, derives the expected 'raw/<id>.md' path with 'raw_exists = true', and parses 'source_asset' from the raw source as 'raw/assets/source.pdf'. [crates/gwiki/src/commands/sources.rs:669-695]
- `missing_raw_file_degrades_without_failing_source_listing` (function) component `missing_raw_file_degrades_without_failing_source_listing [function]` (`a07ac043-cdd3-5464-96b6-e19b5ad08c16`) lines 698-716 [crates/gwiki/src/commands/sources.rs:698-716]
  ...
  - Purpose: Verifies that 'source_entries' returns an entry with the expected 'raw/<id>.md' path and 'raw_exists == false' when the raw file is missing, while recording a 'raw_missing:<path>' degradation instead of failing. [crates/gwiki/src/commands/sources.rs:698-716]
- `source_asset_path_rejects_traversal_absolute_and_non_raw_assets` (function) component `source_asset_path_rejects_traversal_absolute_and_non_raw_assets [function]` (`4f5cf1d6-4f02-5eed-9284-99d4570e18cf`) lines 719-730 [crates/gwiki/src/commands/sources.rs:719-730]
  ...
  - Purpose: Verifies that 'source_asset_path' rejects path traversal, absolute paths, and non-raw asset paths by returning an 'invalid_input' error for each unsafe input. [crates/gwiki/src/commands/sources.rs:719-730]
- `raw_source_path_trims_source_ids_before_building_path` (function) component `raw_source_path_trims_source_ids_before_building_path [function]` (`e25b38e0-3370-50c2-b52a-758e6c8c985e`) lines 733-738 [crates/gwiki/src/commands/sources.rs:733-738]
  ...
  - Purpose: Verifies that 'raw_source_path' trims surrounding whitespace from a source ID before constructing the markdown path, producing 'raw/src-abc.md' for '" src-abc "'. [crates/gwiki/src/commands/sources.rs:733-738]
- `manifest_remove_deletes_only_matching_source_record` (function) component `manifest_remove_deletes_only_matching_source_record [function]` (`0d0ab174-357e-54b8-9491-e34fe1ad5bb2`) lines 741-767 [crates/gwiki/src/commands/sources.rs:741-767]
  ...
  - Purpose: Creates two source manifest entries, removes the one matching 'first.id', and asserts the returned record is the removed entry while the manifest retains only the non-matching 'second' entry. [crates/gwiki/src/commands/sources.rs:741-767]
- `removed_source_files_restore_after_later_failure` (function) component `removed_source_files_restore_after_later_failure [function]` (`acced69f-abbb-5ca6-9dba-c8ab0bfdb371`) lines 770-812 [crates/gwiki/src/commands/sources.rs:770-812]
  ...
  - Purpose: Verifies that after staged raw source and asset files are removed, 'restore_removed_source_files' recreates both files with their original bytes when a later 'WikiError::Config' failure occurs. [crates/gwiki/src/commands/sources.rs:770-812]
- `rollback_removed_source_reports_manifest_race` (function) component `rollback_removed_source_reports_manifest_race [function]` (`0a8d327d-259c-51be-ade0-98eb40c069a4`) lines 815-828 [crates/gwiki/src/commands/sources.rs:815-828]
  ...
  - Purpose: Verifies that 'rollback_removed_source' returns an error when it would reintroduce a manifest source that already exists, and that the resulting error message preserves the original '"remove failed"' detail. [crates/gwiki/src/commands/sources.rs:815-828]
- `compiled_source_requests_audit_follow_up` (function) component `compiled_source_requests_audit_follow_up [function]` (`73352dc8-2d1d-51d6-91a9-872df62ea01c`) lines 831-839 [crates/gwiki/src/commands/sources.rs:831-839]
  ...
  - Purpose: Verifies that a compiled manifest source record is assigned the 'audit_recommended' follow-up when passed to 'follow_up_for_removed_source'. [crates/gwiki/src/commands/sources.rs:831-839]
- `seed_manifest_source` (function) component `seed_manifest_source [function]` (`379f6256-1fc9-586d-9383-6ca5fb30b562`) lines 841-857 [crates/gwiki/src/commands/sources.rs:841-857]
  ...
  - Purpose: Registers a 'SourceDraft' for 'https://example.com/source' with fixed example metadata and the provided 'compile_status' via 'SourceManifest::register', then unwraps the resulting 'SourceRecord' with 'expect("register source")'. [crates/gwiki/src/commands/sources.rs:841-857]
- `write_raw_source` (function) component `write_raw_source [function]` (`0cb76e39-f33d-55a6-a351-c7f8121477cb`) lines 859-874 [crates/gwiki/src/commands/sources.rs:859-874]
  ...
  - Purpose: Creates the 'raw/{id}.md' file under 'root', ensuring the directory exists, and writes a Markdown document with fixed 'source_kind: url' frontmatter plus any supplied extra frontmatter and a '# Example source' heading. [crates/gwiki/src/commands/sources.rs:859-874]
