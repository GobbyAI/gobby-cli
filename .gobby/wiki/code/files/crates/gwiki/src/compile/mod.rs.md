...
- `compile_to_wiki` (function) component `compile_to_wiki [function]` (`435b71d5-dfcf-5490-9dc3-4f3f473793ad`) lines 93-98 [crates/gwiki/src/compile/mod.rs:93-98]
  - Signature: `pub fn compile_to_wiki(`
  - Purpose: Indexed function `compile_to_wiki` in `crates/gwiki/src/compile/mod.rs`. [crates/gwiki/src/compile/mod.rs:93-98]
- `compile_to_wiki_with_options` (function) component `compile_to_wiki_with_options [function]` (`69d66cc7-b233-5883-90c3-a3afd71cba27`) lines 100-185 [crates/gwiki/src/compile/mod.rs:100-185]
  - Signature: `pub fn compile_to_wiki_with_options(`
  - Purpose: Indexed function `compile_to_wiki_with_options` in `crates/gwiki/src/compile/mod.rs`. [crates/gwiki/src/compile/mod.rs:100-185]
- `prepare_handoff` (function) component `prepare_handoff [function]` (`7f0538f2-0306-5b6e-ab00-51c50cc5070e`) lines 187-261 [crates/gwiki/src/compile/mod.rs:187-261]
  - Signature: `pub fn prepare_handoff(`
  - Purpose: Indexed function `prepare_handoff` in `crates/gwiki/src/compile/mod.rs`. [crates/gwiki/src/compile/mod.rs:187-261]
- `CollectedSources` (class) component `CollectedSources [class]` (`3af94de7-7485-5c14-a987-6422e03c702b`) lines 264-269 [crates/gwiki/src/compile/mod.rs:264-269]
  - Signature: `pub(crate) struct CollectedSources {`
  - Purpose: Indexed class `CollectedSources` in `crates/gwiki/src/compile/mod.rs`. [crates/gwiki/src/compile/mod.rs:264-269]
- `index_lock_timeout` (function) component `index_lock_timeout [function]` (`12ad8f2c-dfd5-5fbd-9d18-711b84f6ca62`) lines 271-284 [crates/gwiki/src/compile/mod.rs:271-284]
  - Signature: `pub(crate) fn index_lock_timeout() -> Duration {`
  - Purpose: Indexed function `index_lock_timeout` in `crates/gwiki/src/compile/mod.rs`. [crates/gwiki/src/compile/mod.rs:271-284]
