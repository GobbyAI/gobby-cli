...
`crates/gwiki/src/research_loop/tests.rs` exposes 49 indexed API symbols.
...
- `FakeModel` (class) component `FakeModel [class]` (`868b2217-5d95-55f7-8f85-ed8326e12078`) lines 12-14 [crates/gwiki/src/research_loop/tests.rs:12-14]
  ...
  - Purpose: FakeModel is a struct that maintains a double-ended queue of ModelDecision objects. [crates/gwiki/src/research_loop/tests.rs:12-14]
- `FakeModel` (class) component `FakeModel [class]` (`dca03cfa-e89e-540b-aa6c-f9a7d92fc012`) lines 16-22 [crates/gwiki/src/research_loop/tests.rs:16-22]
  ...
  - Purpose: `FakeModel::new` is a constructor that initializes a `FakeModel` instance by consuming a `Vec<ModelDecision>` and converting it via the `Into` trait into a `decisions` field. [crates/gwiki/src/research_loop/tests.rs:16-22]
...
- `FakeModel` (class) component `FakeModel [class]` (`1e6ececa-0fe5-588c-b325-3df05b2bd832`) lines 24-33 [crates/gwiki/src/research_loop/tests.rs:24-33]
  ...
  - Purpose: FakeModel is a mock ResearchModel implementation that returns pre-queued ModelDecisions in FIFO order via `next_action()`, raising an `InvalidResponse` error when the deque is exhausted. [crates/gwiki/src/research_loop/tests.rs:24-33]
- `FakeModel.next_action` (method) component `FakeModel.next_action [method]` (`2570ba48-e22d-5e49-93d2-895acfdb88c2`) lines 25-32 [crates/gwiki/src/research_loop/tests.rs:25-32]
  ...
  - Purpose: Removes and returns the front `ModelDecision` from a queue via `pop_front()`, or returns a `ResearchModelError` with message "no decision" if the queue is empty. [crates/gwiki/src/research_loop/tests.rs:25-32]
- `BudgetModel` (class) component `BudgetModel [class]` (`20cb03c3-f881-5291-abc8-74aea3e103b8`) lines 35-35 [crates/gwiki/src/research_loop/tests.rs:35]
  ...
  - Purpose: BudgetModel is a forward-declared struct with no visible implementation details in the provided source code. [crates/gwiki/src/research_loop/tests.rs:35]
- `BudgetModel` (class) component `BudgetModel [class]` (`04c33b0e-d324-5acc-82f0-3e600685ed55`) lines 37-44 [crates/gwiki/src/research_loop/tests.rs:37-44]
  ...
  - Purpose: BudgetModel implements the ResearchModel trait by unconditionally rejecting all `next_action` requests with a `BudgetExceeded` error. [crates/gwiki/src/research_loop/tests.rs:37-44]
- `BudgetModel.next_action` (method) component `BudgetModel.next_action [method]` (`abb726db-3ebf-5fb0-85da-bb47292a69d8`) lines 38-43 [crates/gwiki/src/research_loop/tests.rs:38-43]
  - Signature: `fn next_action(`
  - Purpose: This method unconditionally returns a `ResearchModelError::BudgetExceeded` error, effectively acting as a no-op stub that prevents any model decision from being generated. [crates/gwiki/src/research_loop/tests.rs:38-43]
- `AiUnavailableModel` (class) component `AiUnavailableModel [class]` (`7a802989-d790-50cb-98b4-0be3a91af333`) lines 46-46 [crates/gwiki/src/research_loop/tests.rs:46]
  ...
  - Purpose: `AiUnavailableModel` is a zero-sized marker struct used to represent an unavailable or uninitialized AI model state in a type-safe manner. [crates/gwiki/src/research_loop/tests.rs:46]
- `AiUnavailableModel` (class) component `AiUnavailableModel [class]` (`9e836069-8fda-5b9d-b38f-b3af22e1ff3e`) lines 48-57 [crates/gwiki/src/research_loop/tests.rs:48-57]
  ...
  - Purpose: `AiUnavailableModel` is a `ResearchModel` implementation that unconditionally returns an `AiUnavailable` error when `next_action` is invoked, effectively disabling the text generation route. [crates/gwiki/src/research_loop/tests.rs:48-57]
- `AiUnavailableModel.next_action` (method) component `AiUnavailableModel.next_action [method]` (`3de4015c-374a-51ac-a83e-307a66edc20d`) lines 49-56 [crates/gwiki/src/research_loop/tests.rs:49-56]
  - Signature: `fn next_action(`
  - Purpose: The method unconditionally returns a `ResearchModelError::AiUnavailable` error result, indicating the text generation route is disabled. [crates/gwiki/src/research_loop/tests.rs:49-56]
- `FakeSearch` (class) component `FakeSearch [class]` (`f669f3c7-4b47-5425-91cd-db497e5c9c75`) lines 59-59 [crates/gwiki/src/research_loop/tests.rs:59]
  ...
  - Purpose: FakeSearch is a unit struct (zero-sized empty struct) likely intended as a placeholder or mock implementation for testing purposes. [crates/gwiki/src/research_loop/tests.rs:59]
- `FakeSearch` (class) component `FakeSearch [class]` (`3a8ff63e-be78-50f3-a28c-cd895e82da30`) lines 61-68 [crates/gwiki/src/research_loop/tests.rs:61-68]
  ...
  - Purpose: `FakeSearch` is a mock implementation of the `WikiSearch` trait that returns a synthesized `ResearchObservation` containing the query string and a hardcoded source reference, without performing actual search operations. [crates/gwiki/src/research_loop/tests.rs:61-68]
- `FakeSearch.search` (method) component `FakeSearch.search [method]` (`20696c09-b5e1-5b60-9b6e-b257b696964d`) lines 62-67 [crates/gwiki/src/research_loop/tests.rs:62-67]
  ...
  - Purpose: Constructs a `ResearchObservation` from the search query and returns it as `Ok` with a hardcoded source file reference, ignoring the limit parameter. [crates/gwiki/src/research_loop/tests.rs:62-67]
- `FakeAsk` (class) component `FakeAsk [class]` (`eefd9137-f916-54d7-9ac9-396ad24c724c`) lines 70-70 [crates/gwiki/src/research_loop/tests.rs:70]
  ...
  - Purpose: FakeAsk is a zero-sized unit struct with no fields or members defined. [crates/gwiki/src/research_loop/tests.rs:70]
- `FakeAsk` (class) component `FakeAsk [class]` (`8c429fc5-cc0e-5a39-9eb0-f0a07738dace`) lines 72-76 [crates/gwiki/src/research_loop/tests.rs:72-76]
  ...
  - Purpose: FakeAsk is a mock implementation of the WikiAsk trait that returns a trivial ResearchObservation echoing the input query string, useful for testing without actual research operations. [crates/gwiki/src/research_loop/tests.rs:72-76]
- `FakeAsk.ask` (method) component `FakeAsk.ask [method]` (`f97f5aed-7785-57f8-abf9-050ded606d75`) lines 73-75 [crates/gwiki/src/research_loop/tests.rs:73-75]
  ...
  - Purpose: Accepts a query string and returns a successful Result containing a new ResearchObservation that logs the query. [crates/gwiki/src/research_loop/tests.rs:73-75]
...
`FakeRead` is a zero-sized unit struct designed as a mock implementation for testing or stubbing read operations. [crates/gwiki/src/research_loop/tests.rs:78]
- `FakeRead` (class) component `FakeRead [class]` (`67a6b069-c3c9-5ce0-80db-ad1a47ca5ebb`) lines 80-85 [crates/gwiki/src/research_loop/tests.rs:80-85]
  ...
  - Purpose: `FakeRead` is a mock implementation of the `WikiRead` trait that returns a successful `ResearchObservation` containing the operation name and source path without performing actual file I/O. [crates/gwiki/src/research_loop/tests.rs:80-85]
- `FakeRead.read` (method) component `FakeRead.read [method]` (`81667992-210f-5047-a391-0f965ff939e1`) lines 81-84 [crates/gwiki/src/research_loop/tests.rs:81-84]
  ...
  - Purpose: Constructs and returns a successful `ResearchObservation` for a 'read' operation, converting the given path to a string and registering it as the observation's sole source. [crates/gwiki/src/research_loop/tests.rs:81-84]
- `FakeIngest` (class) component `FakeIngest [class]` (`04e30e71-376a-5203-b379-eaed9eec89e0`) lines 87-87 [crates/gwiki/src/research_loop/tests.rs:87]
  ...
  - Purpose: FakeIngest is a zero-sized unit struct (marker type) with no fields, likely used as a placeholder or mock implementation. [crates/gwiki/src/research_loop/tests.rs:87]
- `FakeIngest` (class) component `FakeIngest [class]` (`fc342d7f-4083-5735-aa1c-a58ba422b2f8`) lines 89-100 [crates/gwiki/src/research_loop/tests.rs:89-100]
  ...
  - Purpose: FakeIngest is a stub implementation of the SourceIngestor trait that wraps input URLs and file paths directly into ResearchObservation objects without performing actual ingestion. [crates/gwiki/src/research_loop/tests.rs:89-100]
- `FakeIngest.ingest_url` (method) component `FakeIngest.ingest_url [method]` (`b969ee74-a591-5b43-ba14-c0a23b51b1b1`) lines 90-92 [crates/gwiki/src/research_loop/tests.rs:90-92]
  ...
  - Purpose: Constructs a `ResearchObservation` with the provided URL as its identifier and source, returning it wrapped in a successful `Result`. [crates/gwiki/src/research_loop/tests.rs:90-92]
- `FakeIngest.ingest_file` (method) component `FakeIngest.ingest_file [method]` (`ffa466ce-2193-5ba7-8f73-4d3f022c7932`) lines 94-99 [crates/gwiki/src/research_loop/tests.rs:94-99]
  ...
  - Purpose: Creates a `ResearchObservation` containing the input file path as both the observation metadata and source record, returning it wrapped in `Ok`. [crates/gwiki/src/research_loop/tests.rs:94-99]
- `FakeWriter` (class) component `FakeWriter [class]` (`f98a28b0-7250-50ed-979e-1888af530d87`) lines 103-106 [crates/gwiki/src/research_loop/tests.rs:103-106]
  ...
  - Purpose: FakeWriter is a test mock struct that aggregates AcceptedNoteDraft items and tracks whether a conflict occurred during note writing operations. [crates/gwiki/src/research_loop/tests.rs:103-106]
- `FakeWriter` (class) component `FakeWriter [class]` (`2849f45a-8c31-5beb-bfb7-41c5a972d336`) lines 108-122 [crates/gwiki/src/research_loop/tests.rs:108-122]
  ...
  - Purpose: `FakeWriter` is a mock implementation of `ResearchNoteWriter` that appends notes to an in-memory collection and returns a `NoteWriteOutcome` with creation/conflict status controlled by an internal `conflict` flag. [crates/gwiki/src/research_loop/tests.rs:108-122]
- `FakeWriter.write_note` (method) component `FakeWriter.write_note [method]` (`98b2d462-53c6-561e-9f74-ceabb4d03be6`) lines 109-121 [crates/gwiki/src/research_loop/tests.rs:109-121]
  ...
  - Purpose: Appends an `AcceptedNoteDraft` to the internal notes collection and returns a `NoteWriteOutcome` containing the equivalent `AcceptedResearchNote` with a generated markdown path, recording whether a write conflict occurred during the operation. [crates/gwiki/src/research_loop/tests.rs:109-121]
- `test_deps` (function) component `test_deps [function]` (`c5f53028-e831-5797-b91a-b64979035d4b`) lines 124-141 [crates/gwiki/src/research_loop/tests.rs:124-141]
  ...
  - Purpose: Builds and returns a `ResearchLoopDeps<'a>` struct by aggregating the provided mutable trait object references using the builder pattern. [crates/gwiki/src/research_loop/tests.rs:124-141]
...
This test function validates that `ResearchLoopDepsBuilder` correctly reports missing required fields by asserting that building without `model` fails with `ResearchLoopDepsBuildError::Model`, and building without `note_writer` (despite other dependencies being set) fails with `ResearchLoopDepsBuildError::NoteWriter`. [crates/gwiki/src/research_loop/tests.rs:144-168]
- `model_budget_error_stops_as_budget_exhausted` (function) component `model_budget_error_stops_as_budget_exhausted [function]` (`c7a44012-f433-5299-9ea3-2dd3e24d97a9`) lines 171-200 [crates/gwiki/src/research_loop/tests.rs:171-200]
  ...
  - Purpose: Tests that `ResearchLoop` terminates with `ResearchStopReason::BudgetExhausted` when the `BudgetModel` exhausts its allocated budget during execution. [crates/gwiki/src/research_loop/tests.rs:171-200]
- `config` (function) component `config [function]` (`106ce7d0-abf8-546a-bdd2-eb877ce0fd2d`) lines 202-210 [crates/gwiki/src/research_loop/tests.rs:202-210]
  ...
  - Purpose: This function returns a `ResearchLoopConfig` struct with hardcoded execution limits: 12 maximum steps, 24,000 token and note byte limits, 8 maximum sources, and a 900-second wall-time timeout. [crates/gwiki/src/research_loop/tests.rs:202-210]
- `research_code_citations_flow_into_accepted_notes` (function) component `research_code_citations_flow_into_accepted_notes [function]` (`b739b691-6774-5c39-8db8-b3d87db5ad91`) lines 213-299 [crates/gwiki/src/research_loop/tests.rs:213-299]
  ...
  - Purpose: This function integration-tests the flow of code citations from search results through model-driven research actions into accepted research notes within a document research workflow system. [crates/gwiki/src/research_loop/tests.rs:213-299]
...
`CodeSearch` is an empty Rust struct type intended as a base or wrapper for code search functionality. [crates/gwiki/src/research_loop/tests.rs:214]
- `CodeSearch` (class) component `CodeSearch [class]` (`19160217-b7cb-5f88-a0f8-249de8d2f6ad`) lines 216-234 [crates/gwiki/src/research_loop/tests.rs:216-234]
  ...
  - Purpose: `CodeSearch` is a stub implementation of the `WikiSearch` trait that returns a hardcoded `ResearchObservation` with a single code citation to the `handle` function at line 12 in `src/handler.rs`, regardless of the query and limit parameters. [crates/gwiki/src/research_loop/tests.rs:216-234]
- `CodeSearch.search` (method) component `CodeSearch.search [method]` (`2035e60b-0b97-5219-897c-18e6eac473cb`) lines 217-233 [crates/gwiki/src/research_loop/tests.rs:217-233]
  - Signature: `fn search(`
  - Purpose: This method returns a hardcoded `ResearchObservation` containing a single code citation to line 12 of the `handle` function in `src/handler.rs`, ignoring the provided query and limit parameters. [crates/gwiki/src/research_loop/tests.rs:217-233]
...
This test function validates that `ResearchLoop` degrades gracefully to retrieval-only mode, returning candidate code sources and terminating with `AiUnavailable` status when the AI text generation model is disabled. [crates/gwiki/src/research_loop/tests.rs:302-363]
- `ScaffoldSearch` (class) component `ScaffoldSearch [class]` (`2b356d02-2e24-55b9-907d-e733ccf4a85f`) lines 303-303 [crates/gwiki/src/research_loop/tests.rs:303]
  ...
  - Purpose: ScaffoldSearch is a forward-declared struct with no visible implementation, fields, or methods in the provided source code. [crates/gwiki/src/research_loop/tests.rs:303]
- `ScaffoldSearch` (class) component `ScaffoldSearch [class]` (`32aa93e1-0288-5b60-a6c9-5822333ffa77`) lines 305-323 [crates/gwiki/src/research_loop/tests.rs:305-323]
  ...
  - Purpose: ScaffoldSearch is a stub implementation of the WikiSearch trait that unconditionally returns a hardcoded ResearchObservation containing a code citation to the `handle` function in `src/handler.rs` (line 3), regardless of the search query or limit parameters. [crates/gwiki/src/research_loop/tests.rs:305-323]
- `ScaffoldSearch.search` (method) component `ScaffoldSearch.search [method]` (`db87db05-afc8-582d-990a-5b466ec73efc`) lines 306-322 [crates/gwiki/src/research_loop/tests.rs:306-322]
  - Signature: `fn search(`
  - Purpose: This method returns a hardcoded `ResearchObservation` with a single source citation from `handler.rs`, disregarding the provided query and limit parameters. [crates/gwiki/src/research_loop/tests.rs:306-322]
- `research_code_graph_off_keeps_docs_only_degradation_on_notes` (function) component `research_code_graph_off_keeps_docs_only_degradation_on_notes [function]` (`d25e2d85-1245-562e-9d65-33d021ee603f`) lines 366-444 [crates/gwiki/src/research_loop/tests.rs:366-444]
  ...
  - Purpose: This function is a unit test that verifies `ResearchLoop` successfully completes research using only documentation sources while properly recording the unavailable code graph as a degradation in the observation metadata. [crates/gwiki/src/research_loop/tests.rs:366-444]
- `DocsOnlySearch` (class) component `DocsOnlySearch [class]` (`1023b11b-0203-5014-947a-a0c597d2a7e9`) lines 367-367 [crates/gwiki/src/research_loop/tests.rs:367]
  ...
  - Purpose: `DocsOnlySearch` is a zero-sized marker struct used to tag or constrain search operations to documentation-only scope. [crates/gwiki/src/research_loop/tests.rs:367]
- `DocsOnlySearch` (class) component `DocsOnlySearch [class]` (`e9750b24-cea5-501c-a4de-5a942eb36102`) lines 369-379 [crates/gwiki/src/research_loop/tests.rs:369-379]
  ...
  - Purpose: `DocsOnlySearch` is a `WikiSearch` trait implementation that ignores query and limit parameters and unconditionally returns a hardcoded `ResearchObservation` indicating one documentation hit with the shared code graph marked as unavailable. [crates/gwiki/src/research_loop/tests.rs:369-379]
- `DocsOnlySearch.search` (method) component `DocsOnlySearch.search [method]` (`d943d02e-f007-5f87-91f5-d7a75d104550`) lines 370-378 [crates/gwiki/src/research_loop/tests.rs:370-378]
  - Signature: `fn search(`
  - Purpose: This method returns a hardcoded `ResearchObservation` indicating one document hit from `raw/source.md` with a shared code graph unavailability degradation, while ignoring the provided query and limit parameters. [crates/gwiki/src/research_loop/tests.rs:370-378]
- `model_planned_note_is_written_after_source_is_observed` (function) component `model_planned_note_is_written_after_source_is_observed [function]` (`b1de196c-7253-5f73-867e-62645df2cc68`) lines 447-503 [crates/gwiki/src/research_loop/tests.rs:447-503]
  ...
  - Purpose: This test verifies that a ResearchLoop correctly persists a note with proper source attribution when the model accepts a note that references a previously read source file. [crates/gwiki/src/research_loop/tests.rs:447-503]
- `write_conflict_stops_the_run_without_recording_the_note` (function) component `write_conflict_stops_the_run_without_recording_the_note [function]` (`6a519a8c-977f-5548-b811-a4c2dfc83ccb`) lines 506-561 [crates/gwiki/src/research_loop/tests.rs:506-561]
  ...
  - Purpose: This test verifies that when a write conflict occurs during note acceptance in the research loop, execution halts and the note is not recorded or persisted to the filesystem. [crates/gwiki/src/research_loop/tests.rs:506-561]
- `accepted_note_without_observed_source_is_blocked` (function) component `accepted_note_without_observed_source_is_blocked [function]` (`d2f0aa86-55b9-5724-8674-278f915ccaf6`) lines 564-601 [crates/gwiki/src/research_loop/tests.rs:564-601]
  ...
  - Purpose: Tests that the ResearchLoop blocks note acceptance when the referenced source is unobserved, terminating with SourceBlocked status and recording a gap without persisting the note. [crates/gwiki/src/research_loop/tests.rs:564-601]
- `parses_fenced_json_action` (function) component `parses_fenced_json_action [function]` (`18aa5282-ebee-51bd-a569-f12a92744ccf`) lines 604-614 [crates/gwiki/src/research_loop/tests.rs:604-614]
  ...
  - Purpose: This function tests that `parse_model_action` correctly deserializes a markdown-fenced JSON string into a `ResearchAction::Finish` enum variant with the specified reason field. [crates/gwiki/src/research_loop/tests.rs:604-614]
- `file_url_source_references_use_path_scope_validation` (function) component `file_url_source_references_use_path_scope_validation [function]` (`ffae54c0-79ff-5e1f-a715-4426e7dcb8b6`) lines 617-634 [crates/gwiki/src/research_loop/tests.rs:617-634]
  - Signature: `fn file_url_source_references_use_path_scope_validation() {`
  - Purpose: This test validates that `validate_source_reference` correctly enforces wiki root scope validation by accepting file URLs within the wiki root directory and rejecting those outside it. [crates/gwiki/src/research_loop/tests.rs:617-634]
- `source_reference_rejects_relative_symlink_escape` (function) component `source_reference_rejects_relative_symlink_escape [function]` (`b0578679-023b-5674-96f9-92eb878f6dbb`) lines 638-652 [crates/gwiki/src/research_loop/tests.rs:638-652]
  - Signature: `fn source_reference_rejects_relative_symlink_escape() {`
  - Purpose: This test verifies that `validate_source_reference()` correctly rejects a relative symlink path that resolves to a location outside the wiki root directory. [crates/gwiki/src/research_loop/tests.rs:638-652]
