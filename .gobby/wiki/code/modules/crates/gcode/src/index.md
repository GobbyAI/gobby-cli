...
[crates/gcode/src/index/import_resolution/predicates.rs:304-316]
[crates/gcode/src/index/import_resolution/predicates.rs:318-328]
- [[code/modules/crates/gcode/src/index/indexer|crates/gcode/src/index/indexer]] - This module implements the core indexing pipeline for the G-code crate. It orchestrates file discovery, freshness checking, and semantic fact extraction across discovered, explicit, and overlay files. The system routes files through a processing pipeline, writes extracted symbols, imports, calls, and content chunks to a configurable storage sink, and manages lifecycle operations including invalidation, stale file detection, and stale projection cleanup. It also provides utilities for path normalization, Git status integration, and handling unsupported file types to ensure efficient and consistent code indexing.
[crates/gcode/src/index/indexer/file.rs:15-91]
[crates/gcode/src/index/indexer/file.rs:93-108]
[crates/gcode/src/index/indexer/file.rs:111-115]
[crates/gcode/src/index/indexer/file.rs:117-127]
