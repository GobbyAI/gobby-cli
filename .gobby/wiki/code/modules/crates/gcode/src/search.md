...
- [[code/modules/crates/gcode/src/search/fts|crates/gcode/src/search/fts]] - The `fts` module implements full-text search over a Postgres-backed code index, covering symbols, file content, and text queries with optional visibility filtering.
