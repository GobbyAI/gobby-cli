...
gcore serves as the application's foundational runtime core, orchestrating configuration resolution, service provisioning, and backend integrations. It manages a layered configuration system that merges environment variables, YAML files, and remote stores while enforcing secret detection and validation. The module handles infrastructure lifecycle through Docker Compose, defining and monitoring FalkorDB, Qdrant, and PostgreSQL services with automated health checks, volume management, and hub identity verification. It provides unified, capability-aware interfaces for AI backend communication—including transport abstraction, health probing, and degradation tracking—and integrates vector search via Qdrant, graph database connectivity, and hybrid search ranking (RRF). Supporting utilities include CLI command contracts, environment-aware context construction, content chunking, and stable infrastructure component identifiers.
...
[crates/gcore/assets/docker-compose.services.yml:17-18]
[crates/gcore/assets/docker-compose.services.yml:19-26]
[crates/gcore/assets/docker-compose.services.yml:21-23]
[crates/gcore/assets/docker-compose.services.yml:24]
[crates/gcore/assets/docker-compose.services.yml:25]
[crates/gcore/assets/docker-compose.services.yml:26]
[crates/gcore/assets/docker-compose.services.yml:27]
[crates/gcore/assets/docker-compose.services.yml:28]
[crates/gcore/assets/docker-compose.services.yml:30-49]
[crates/gcore/assets/docker-compose.services.yml:31]
[crates/gcore/assets/docker-compose.services.yml:32-34]
[crates/gcore/assets/docker-compose.services.yml:35-38]
[crates/gcore/assets/docker-compose.services.yml:39-40]
[crates/gcore/assets/docker-compose.services.yml:41-45]
[crates/gcore/assets/docker-compose.services.yml:42]
[crates/gcore/assets/docker-compose.services.yml:43]
[crates/gcore/assets/docker-compose.services.yml:44]
[crates/gcore/assets/docker-compose.services.yml:45]
[crates/gcore/assets/docker-compose.services.yml:46]
[crates/gcore/assets/docker-compose.services.yml:47-49]
[crates/gcore/assets/docker-compose.services.yml:51-117]
[crates/gcore/assets/docker-compose.services.yml:52-56]
[crates/gcore/assets/docker-compose.services.yml:53]
[crates/gcore/assets/docker-compose.services.yml:54-56]
[crates/gcore/assets/docker-compose.services.yml:55]
[crates/gcore/assets/docker-compose.services.yml:56]
[crates/gcore/assets/docker-compose.services.yml:57]
[crates/gcore/assets/docker-compose.services.yml:58]
[crates/gcore/assets/docker-compose.services.yml:59-82]
[crates/gcore/assets/docker-compose.services.yml:83-87]
[crates/gcore/assets/docker-compose.services.yml:84]
[crates/gcore/assets/docker-compose.services.yml:85]
[crates/gcore/assets/docker-compose.services.yml:86]
[crates/gcore/assets/docker-compose.services.yml:87]
[crates/gcore/assets/docker-compose.services.yml:88-89]
[crates/gcore/assets/docker-compose.services.yml:90-92]
[crates/gcore/assets/docker-compose.services.yml:93-113]
[crates/gcore/assets/docker-compose.services.yml:94-110]
[crates/gcore/assets/docker-compose.services.yml:111]
[crates/gcore/assets/docker-compose.services.yml:112]
[crates/gcore/assets/docker-compose.services.yml:113]
[crates/gcore/assets/docker-compose.services.yml:114]
[crates/gcore/assets/docker-compose.services.yml:115-117]
[crates/gcore/assets/docker-compose.services.yml:119-128]
[crates/gcore/assets/docker-compose.services.yml:120-121]
[crates/gcore/assets/docker-compose.services.yml:121]
[crates/gcore/assets/docker-compose.services.yml:122-123]
[crates/gcore/assets/docker-compose.services.yml:123]
[crates/gcore/assets/docker-compose.services.yml:124-125]
[crates/gcore/assets/docker-compose.services.yml:125]
[crates/gcore/assets/docker-compose.services.yml:126-128]
[crates/gcore/assets/docker-compose.services.yml:127]
...
- [[code/modules/crates/gcore/assets|crates/gcore/assets]] - crates/gcore/assets manages infrastructure definitions and configuration assets for the application's data stack. It exposes Docker Compose service configurations for FalkorDB, Qdrant, and PostgreSQL, detailing health checks, volume mounts, restart policies, and environment variables. The module integrates specialized tooling for PostgreSQL, supporting `pg_search` and `pgaudit` extensions with architecture-specific versioning and integrity verification. It maintains stable component IDs for service properties and metadata, serving as the central repository for operational infrastructure definitions.
[crates/gcore/assets/docker-compose.services.yml:5-117]
[crates/gcore/assets/docker-compose.services.yml:6-28]
[crates/gcore/assets/docker-compose.services.yml:7]
[crates/gcore/assets/docker-compose.services.yml:8-10]
