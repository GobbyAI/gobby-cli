...
The `ghook` crate implements a CLI-based hook interception and dispatch system for AI coding assistants. It captures terminal and CLI context, constructs and validates dispatch envelopes, and manages message routing through a local inbox with quarantine support for malformed payloads. The module handles graceful shutdown via planned shutdown markers, enforces environment-based suppression rules, and provides robust transport error handling when posting to a target daemon. It also includes diagnostic utilities, install provenance tracking, and JSON schema validation to ensure type safety and consistent data structures across internal messaging and reporting APIs.
...
[crates/ghook/schemas/diagnose-output.v2.schema.json:7-18]
[crates/ghook/schemas/diagnose-output.v2.schema.json:19]
[crates/ghook/schemas/diagnose-output.v2.schema.json:20-79]
[crates/ghook/schemas/diagnose-output.v2.schema.json:21-24]
[crates/ghook/schemas/diagnose-output.v2.schema.json:22]
[crates/ghook/schemas/diagnose-output.v2.schema.json:23]
[crates/ghook/schemas/diagnose-output.v2.schema.json:25-28]
[crates/ghook/schemas/diagnose-output.v2.schema.json:26]
[crates/ghook/schemas/diagnose-output.v2.schema.json:27]
[crates/ghook/schemas/diagnose-output.v2.schema.json:29-32]
[crates/ghook/schemas/diagnose-output.v2.schema.json:30]
[crates/ghook/schemas/diagnose-output.v2.schema.json:31]
[crates/ghook/schemas/diagnose-output.v2.schema.json:33-36]
[crates/ghook/schemas/diagnose-output.v2.schema.json:34]
[crates/ghook/schemas/diagnose-output.v2.schema.json:35]
[crates/ghook/schemas/diagnose-output.v2.schema.json:37-39]
[crates/ghook/schemas/diagnose-output.v2.schema.json:38]
[crates/ghook/schemas/diagnose-output.v2.schema.json:40-42]
[crates/ghook/schemas/diagnose-output.v2.schema.json:41]
[crates/ghook/schemas/diagnose-output.v2.schema.json:43-45]
[crates/ghook/schemas/diagnose-output.v2.schema.json:44]
[crates/ghook/schemas/diagnose-output.v2.schema.json:46-49]
[crates/ghook/schemas/diagnose-output.v2.schema.json:47]
[crates/ghook/schemas/diagnose-output.v2.schema.json:48]
[crates/ghook/schemas/diagnose-output.v2.schema.json:50-53]
[crates/ghook/schemas/diagnose-output.v2.schema.json:51]
[crates/ghook/schemas/diagnose-output.v2.schema.json:52]
[crates/ghook/schemas/diagnose-output.v2.schema.json:54-58]
[crates/ghook/schemas/diagnose-output.v2.schema.json:55]
[crates/ghook/schemas/diagnose-output.v2.schema.json:56]
[crates/ghook/schemas/diagnose-output.v2.schema.json:57]
[crates/ghook/schemas/diagnose-output.v2.schema.json:59-61]
[crates/ghook/schemas/diagnose-output.v2.schema.json:60]
[crates/ghook/schemas/diagnose-output.v2.schema.json:62-64]
[crates/ghook/schemas/diagnose-output.v2.schema.json:63]
[crates/ghook/schemas/diagnose-output.v2.schema.json:65-67]
[crates/ghook/schemas/diagnose-output.v2.schema.json:66]
[crates/ghook/schemas/diagnose-output.v2.schema.json:68-70]
[crates/ghook/schemas/diagnose-output.v2.schema.json:69]
[crates/ghook/schemas/diagnose-output.v2.schema.json:71-74]
[crates/ghook/schemas/diagnose-output.v2.schema.json:72]
[crates/ghook/schemas/diagnose-output.v2.schema.json:73]
[crates/ghook/schemas/diagnose-output.v2.schema.json:75-78]
[crates/ghook/schemas/diagnose-output.v2.schema.json:76]
[crates/ghook/schemas/diagnose-output.v2.schema.json:77]
...
[crates/ghook/src/diagnose.rs:128-134]
[crates/ghook/src/diagnose.rs:137-143]
[crates/ghook/src/diagnose.rs:146-152]
[crates/ghook/src/diagnose.rs:155-161]
[crates/ghook/src/diagnose.rs:163-170]
[crates/ghook/src/diagnose.rs:172-177]
[crates/ghook/src/diagnose.rs:180-192]
[crates/ghook/src/diagnose.rs:195-207]
[crates/ghook/src/diagnose.rs:210-213]
[crates/ghook/src/diagnose.rs:216-221]
[crates/ghook/src/diagnose.rs:224-246]
[crates/ghook/src/diagnose.rs:249-256]
[crates/ghook/src/diagnose.rs:259-266]
...
[crates/ghook/src/statusline.rs:117-130]
[crates/ghook/src/statusline.rs:132-165]
[crates/ghook/src/statusline.rs:168-172]
[crates/ghook/src/statusline.rs:175-179]
[crates/ghook/src/statusline.rs:193-229]
[crates/ghook/src/statusline.rs:232-237]
[crates/ghook/src/statusline.rs:240-244]
[crates/ghook/src/statusline.rs:247-251]
[crates/ghook/src/statusline.rs:254-260]
[crates/ghook/src/statusline.rs:263-268]
[crates/ghook/src/statusline.rs:271-298]
[crates/ghook/src/statusline.rs:301-312]
[crates/ghook/src/statusline.rs:315-335]
...
- [[code/modules/crates/ghook/schemas|crates/ghook/schemas]] - The `crates/ghook/schemas` module defines JSON Schema specifications for `ghook`'s core data structures. It includes `diagnose-output.v2.schema.json`, which structures v2 diagnostic reporting data by capturing CLI environment details, hook metadata, daemon connection parameters, and project context. It also provides `inbox-envelope.v1.schema.json` for v1 message envelopes, defining the structure for queued payloads with fields for enqueue timestamps, criticality flags, hook types, input data, source tracking, and custom HTTP headers. Together, these schemas enforce consistent validation and type safety for the crate's internal messaging and diagnostic APIs.
[crates/ghook/schemas/diagnose-output.v2.schema.json:2]
[crates/ghook/schemas/diagnose-output.v2.schema.json:3]
[crates/ghook/schemas/diagnose-output.v2.schema.json:4]
[crates/ghook/schemas/diagnose-output.v2.schema.json:5]
...
[crates/ghook/schemas/inbox-envelope.v1.schema.json:58]
[crates/ghook/schemas/inbox-envelope.v1.schema.json:59]
- [[code/modules/crates/ghook/src|crates/ghook/src]] - The `ghook` module implements a CLI-based hook interception and dispatch system for AI coding assistants. It manages command-line configuration, critical hook detection, and graceful shutdown via planned shutdown markers and freshness validation. Core functionality includes constructing and validating dispatch envelopes, extracting terminal context (Tmux, TTY, environment), and processing statusline hooks. The module handles envelope enqueueing to a local inbox, quarantining malformed payloads, and posting to a target daemon with robust transport error handling. It also provides diagnostic utilities, provenance tracking, and routing logic for tool-specific success and failure responses while respecting environment-based suppression rules.
[crates/ghook/src/cli_config.rs:11-18]
[crates/ghook/src/cli_config.rs:20-61]
[crates/ghook/src/cli_config.rs:21-52]
[crates/ghook/src/cli_config.rs:54-56]
