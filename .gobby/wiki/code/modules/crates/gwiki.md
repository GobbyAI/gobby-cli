...
- [[code/modules/crates/gwiki/assets|crates/gwiki/assets]] - The assets module for the gwiki crate holds content and documentation resources rather than code. Its sole subcomponent, `skills`, provides four Markdown skill definitions—audit, compile, query, and research—that guide wiki-related operations. The module exposes no indexed API symbols or components. 
