...
fn cargo_features_define_public_boundary() {
    ...
    for expected in [
        "default = []",
        r#"postgres = ["dep:postgres", "dep:postgres-types", "dep:postgres-openssl", "dep:openssl", "dep:pbkdf2", "dep:sha2"]"#,
        r#"falkor = ["dep:falkordb", "dep:urlencoding"]"#,
        r#"qdrant = ["dep:urlencoding"]"#,
        ...
        r#"reqwest = { version = "0.12", default-features = false, features = ["blocking", "json", "multipart", "rustls-tls"] }"#,
        r#"base64 = "0.22""#,
        r#"fernet = "0.2.2""#,
        r#"bytes = "1""#,
        r#"httpdate = "1""#,
