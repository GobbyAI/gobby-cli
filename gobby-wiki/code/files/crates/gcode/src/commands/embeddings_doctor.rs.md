...
| `doctor_json_and_exit_codes` | function | Tests 'build_doctor_report' to ensure it emits the correct JSON report fields and exit codes for missing configuration, a healthy local setup, peer-drift detection, and transport/probe failures. [crates/gcode/src/commands/embeddings_doctor.rs:298-362] |
