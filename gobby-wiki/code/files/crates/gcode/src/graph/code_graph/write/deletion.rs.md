...
`crates/gcode/src/graph/code_graph/write/deletion.rs` is documented from its indexed symbols; see the Key components below and the module page for how it connects to sibling files.
