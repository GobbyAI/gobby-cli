...
`crates/gcode/src/index/import_resolution/context/bindings.rs` is documented from its indexed symbols; see the Key components below and the module page for how it connects to sibling files.
