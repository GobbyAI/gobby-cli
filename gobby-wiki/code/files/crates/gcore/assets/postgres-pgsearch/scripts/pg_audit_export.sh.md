...
`crates/gcore/assets/postgres-pgsearch/scripts/pg_audit_export.sh` is documented from its indexed symbols; see the Key components below and the module page for how it connects to sibling files.
