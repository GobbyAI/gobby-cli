...
`crates/gwiki/src/ingest/file/dispatch.rs` exposes 1 indexed API symbol.

## How it fits

`crates/gwiki/src/ingest/file/dispatch.rs` is documented from its indexed symbols; see the Key components below and the module page for how it connects to sibling files.
