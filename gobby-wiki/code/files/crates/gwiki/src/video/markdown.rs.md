...
`crates/gwiki/src/video/markdown.rs` exposes 2 indexed API symbols.

## How it fits

`crates/gwiki/src/video/markdown.rs` is documented from its indexed symbols; see the Reference table below and the module page for how it connects to sibling files.
