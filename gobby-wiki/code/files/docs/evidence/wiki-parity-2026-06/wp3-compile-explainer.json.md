...
`docs/evidence/wiki-parity-2026-06/wp3-compile-explainer.json` is documented from its indexed symbols; see the Reference table below and the module page for how it connects to sibling files.
...
_8 more symbol(s) not shown — run `gcode outline docs/evidence/wiki-parity-2026-06/wp3-compile-explainer.json` for the full list._
