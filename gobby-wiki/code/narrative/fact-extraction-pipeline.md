---
title: The Code Fact Extraction Pipeline
type: code_narrative
provenance:
...
# The Code Fact Extraction Pipeline

## Guide

Detailed walk-through of GCode's indexers, AST parsers, and custom language-specific import solvers that map and trace symbols back to source coordinates.

## Concepts

- [[code/concepts/filesystem-walker-ingestion|Filesystem Walker & Ingestion]]
- [[code/concepts/import-resolution-syntax-parsing|Import Resolution & Syntax Parsing]]
