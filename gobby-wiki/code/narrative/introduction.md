---
title: Introduction to Gobby and GCode
type: code_narrative
provenance:
...
An architectural tour over the Gobby Rust codebase, showcasing its layered toolchain spanning GCore foundation, GCode code fact indexing, and the AI-driven CodeWiki engine.
