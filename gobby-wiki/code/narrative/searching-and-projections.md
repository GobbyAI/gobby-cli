---
title: Hybrid Searching, Vector & Graph Projections
type: code_narrative
provenance:
...
# Hybrid Searching, Vector & Graph Projections

## Guide

Deep dive into downstream Qdrant vector spaces, FalkorDB relation mapping, and hybrid Reciprocal Rank Fusion query routing.

## Concepts

- [[code/concepts/falkordb-graph-synchronization|FalkorDB Graph Synchronization]]
- [[code/concepts/query-dispatch-search-orchestration|Query Dispatch & Search Orchestration]]
